...
The script ```appareal.ipynb``` evaluates human performance in estimating ages from facial images using the APPA-REAL database and compares it to a neural network-based age predictor.
